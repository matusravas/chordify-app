...
class Repository implements IRepository {
    ...
    async removeSongFromPlaylist(songId: number, playlistId: number): Promise<Data<boolean>> {
        try {
    ...
    async addSongToPlaylist(song: Song, playlistId: number): Promise<Data<boolean>> {
        try {
            ...
            if (resultInsertSongToPlaylist.ok && resultInsertSongToPlaylist.result && resultInsertSongToPlaylist.result.rowsAffected > 0) return {ok: true, data: true}
            else if (resultInsertSongToPlaylist.ok && resultInsertSongToPlaylist.result && resultInsertSongToPlaylist.result.rowsAffected === 0) return {ok: true, data: false}
