...
const SongStackScreen = () => {
  return (
    ...
    <SongStack.Navigator screenOptions={{ animation: 'slide_from_right', headerShadowVisible: false, statusBarColor: '#000000', headerStyle: { backgroundColor: '#1a172d', }, headerTitleStyle: { fontWeight: '400', fontSize: 18 }, headerTintColor: '#F7F7F7AA' }}>
