            ...
            options={{
                tabBarIcon: ({focused, color}) => (
                  <View style={{alignItems: 'center'}}>
                        <Icon type={screen.iconType} name={focused? screen.iconFocused: screen.iconNotFocused} color={focused? '#E7E7E7' : '#FFFFFF22'} size={focused? 26: 24}/>
                        <Text
                          variant='caption'
                          style={{color: focused? '#FFFFFF' : '#FFFFFF55', fontSize: focused? 11: 10}}
                        >{screen.label}
                        </Text>
                    </View>
                    )
