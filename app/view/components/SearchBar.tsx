...
import { TextInput, TouchableOpacity, Keyboard, Animated, View } from 'react-native';
...
interface SearchBarProps {
    ...
    editable?: boolean,
    todaysTop?: boolean,
    onChipSelection?: (selection: 'today'|'all-time') => void,
    // visible: boolean,
    placeholder?: string,
    searchQuery: string,
...
const SearchBar = ({ style, editable, placeholder, searchQuery, onSearch, timeoutMilis = 0, onChipSelection = undefined, todaysTop = undefined, onScrollToTop }: SearchBarProps) => {
    ...
    return (
        ...
        <Animated.View style={{...style, flexDirection: 'column', alignItems: 'center', justifyContent: 'center'}}>
            ...
            <View style={{ flexDirection: 'row', alignSelf: 'stretch', backgroundColor: '#111317', borderColor: focused ? '#1FC159' : '#1FC15920', borderBottomWidth: 1, paddingHorizontal: 10 }}>

                <TouchableOpacity onPress={() => onScrollToTop()}>

                    <Icon style={{ marginLeft: 5, marginRight: 5, marginTop: 15 }} type={Icons.MaterialIcons} name='search' size={22} color={focused ? "#1FC159" : "#F7F7F730"} />
                </TouchableOpacity>
                <TextInput
